...
import { registerAcount } from "../../services/authServices";
...
const RegisterPage = () => {
  ...
  const onSubmit = async (data) => {
    try {
      const response = await registerAcount(data);
      console.log(response);
      confirm("Register successfully") ? nav("/login") : reset();
    } catch (error) {
      console.log(error);
    }
  };
      ...
      <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          ...
          <form
            ...
            className="mt-4 flex flex-col lg:flex-row items-center justify-between"
          >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              />
              {errors?.name && (
                <p className="mp-text-danger">{errors.name.message}</p>
              )}
            </div>
            <div>
              <label
              ...
              />
              {errors?.email && (
                <p className="mp-text-danger">{errors.email.message}</p>
              )}
            </div>
            <div>
              <label
              ...
              />
              {errors?.password && (
                <p className="mp-text-danger">{errors.password.message}</p>
              )}
            </div>
            <div>
              <label
              ...
              />
              {errors?.confirm && (
                <p className="mp-text-danger">{errors.confirm.message}</p>
              )}
            </div>
            <div>
              <button
