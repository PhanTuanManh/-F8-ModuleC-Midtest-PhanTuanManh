...
import { loginAcount } from "../../services/authServices";
...
const LoginPage = () => {
  ...
  const onSubmit = async (data) => {
    const response = await loginAcount(data);
  ...
  return (
    <div className="flex h-screen">
      {/* Left Pane */}
      <div className="hidden lg:flex items-center justify-center flex-1 order-2 bg-white text-black">
